...
export type AcademyReaderCurationPhase = '0.14D' | '0.14E' | '0.14F' | '0.14G' | '0.14H' | '0.14I' | '0.14J' | '0.14K'
...
export interface AcademyReaderDocument {
  readerSchemaVersion: '0.14C' | '0.14D' | '0.14E' | '0.14F' | '0.14G' | '0.14H' | '0.14I' | '0.14J' | '0.14K'
  documentId: string
