export const ACADEMY_STAGE_5_3D_STATES = [
  ...
  {stateId:'3d.stage5.dial-and-hands',represents:['esfera','apilado de agujas','barridos'],requiredInputs:['dial-diameter','dial-thickness','hand-stack-top'],state:'input-incomplete'},
