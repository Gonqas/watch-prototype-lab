...
const sources = [
  ...
  ['source.eta.7750.communication', 'manufacturer-primary', 'official-linked', 'pdf', 'ETA 7750 Technical Communication', 'https://portal.eta.ch/en/technicaldocuments/index/pdf/id/2180/', 'ETA', 'official-primary', 'Despiece y documentación técnica oficial del ETA 7750.'],
...
const topics = [
  ...
  },
  {
    ...
    question: '¿Qué relación remove-before justifica cada retirada?',
