...
c(7,'learning-content no cambia',()=>expect(ACADEMY_014K_BASELINE.protected.learningContent).toEqual({count:4012,digest:'16291f86a7cb082d47fa65016d838b72e19cf3701afe33bc27ad226cf41af1d4'}))
...
c(9,'los informes A–J conservan snapshot byte a byte',()=>expect(ACADEMY_014K_BASELINE.protected.historicalReports).toEqual({count:199,digest:'4415ce47f054a7feb60902e73abb71dfcd5d7d882a6bdbbd577e1b2a686c4186'}))
...
c(96,'el dossier conserva unknowns y conflictos',()=>expect(ACADEMY_STAGE_5_DOSSIER_SECTIONS).toEqual(expect.arrayContaining(['Unknowns','Conflictos'])))
